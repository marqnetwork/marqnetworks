    ...
    <section className="portfolio">
      <div className="portfolio__content">
        ...
        <p className="portfolio__description">
          From SaaS scale-ups and e-commerce launches to government-ready
          solutions, each case <br />
          study proves how our cross-disciplinary team turns complexity into
          measurable results.
        </p>
