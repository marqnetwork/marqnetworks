      ...
      <div className="hero__container">
        <div className="hero__content">
          ...
          <p className="hero__para">
            “Strategy, design, cod, and growth—engineered as one seamless stack. From AI-driven digital transformation consultancy and branding to custom software development and funnel marketing with CRM automation, MarQ Networks turns clicks into revenue for scaling teams across the U.S. & GCC.
            <br/>
            <br />
