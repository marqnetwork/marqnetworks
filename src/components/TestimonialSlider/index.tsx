...
const TestimonialSlider = () => {
 ...
 return (
  <div className="w-full bg-black flex flex-col items-center justify-center px-4">
    ...
    <div
      className="w-full max-w-[1200px] h-auto md:h-[85vh] flex flex-col md:flex-row rounded-3xl overflow-hidden shadow-xl"
      onMouseEnter={() => setIsHovered(true)}
      onMouseLeave={() => setIsHovered(false)}
    >
      {/* LEFT SIDE */}
      <div className="w-full md:w-1/2 text-white bg-red-500 flex flex-col justify-between p-4 md:p-6 left_side">
        <div>
        ...
        <div className="flex-1 flex items-center mt-4 md:mt-0">
          <AnimatePresence mode="wait" custom={direction}>
            <motion.blockquote
              ...
              animate="center"
              exit="exit"
              className="text-lg md:text-2xl font-medium leading-relaxed max-w-md text-justify"
            >
              “{current.quote}”
            </motion.blockquote>
          </AnimatePresence>
      ...
      {/* RIGHT SIDE */}
      <div className="w-full md:w-1/2 bg-[#f15a29] flex items-center justify-center p-4 md:p-6">
